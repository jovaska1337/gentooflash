...
# sources are cached locally because Adobe won't be hosting them for much longer.
SRC_URI="
	nsplugin? (
		abi_x86_32? ( ${FILESDIR}/archives/${P}-npapi.i386.tar.gz )
		abi_x86_64? ( ${FILESDIR}/archives/${P}-npapi.x86_64.tar.gz )
	)
	ppapi? (
		abi_x86_32? ( ${FILESDIR}/archives/${P}-ppapi.i386.tar.gz )
		abi_x86_64? ( ${FILESDIR}/archives/${P}-ppapi.x86_64.tar.gz )
	)
"
SLOT="22"
